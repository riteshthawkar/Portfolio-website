...
import doodleAvatar from "@/public/images/doodle-avatar.png"
  ...
  return (
    <section id="about" className="scroll-mt-20 px-6 pb-4 pt-28 sm:pb-8 sm:pt-36">
      <div className="site-shell">
        ...
        <div className="mt-14 grid items-start gap-8 sm:mt-20 md:grid-cols-[minmax(0,1fr)_12rem] md:gap-10 lg:grid-cols-[minmax(0,1fr)_14rem] lg:gap-14">
          ...
          <div className="hero-reveal order-first w-32 justify-self-start [animation-delay:220ms] sm:w-36 md:order-last md:mt-4 md:w-full">
            <Image
              src={doodleAvatar}
              alt={`Doodle avatar of ${profile.person.name}`}
              priority
              sizes="(min-width: 1024px) 224px, (min-width: 768px) 192px, 144px"
              className="doodle-avatar h-auto w-full select-none"
              draggable={false}
            />
          </div>
        </div>
